...
\begin{table}[h]
  ...
  \hline
  \multirow{2}{*}{\textbf{Strategy}} & \multicolumn{2}{c|}{\textbf{BlueBirds}} & \multicolumn{2}{c|}{\textbf{Temp}} & \multicolumn{2}{c|}{\textbf{Df 3}} & \multicolumn{2}{c}{\textbf{Df 4}} \\
  \cline{2-9}
   & \textbf{Accuracy} & \textbf{F1 Score} & \textbf{Accuracy} & \textbf{F1 Score} & \textbf{Accuracy} & \textbf{F1 Score} & \textbf{Accuracy} & \textbf{F1 Score} \\
  \hline
  MV    & 0.759 & 0.742 & 0.569 & 0.385 & 0. & 0. & 0. & 0. \\
  WAWA  & 0.759 & 0.742 & 0.945 & 0.945 & 0. & 0. & 0. & 0. \\
  ZBS   & 0.648 & 0.623 & 0.943 & 0.943 & 0. & 0. & 0. & 0. \\
  WDS   & 0.759 & 0.736 & 0.945 & 0.945 & 0. & 0. & 0. & 0. \\
  KOS   & 0.630 & 0.570 & 0.569 & 0.384 & --- & --- & --- & --- \\
  M-MSR & 0.639 & 0.578 & 0.924 & 0.922 & 0. & 0. & 0. & 0. \\
  \rowcolor{lightgray} Shapley & \textbf{0.805}& \textbf{0.794}& \textbf{0.945} & \textbf{0.945} & & & & \\
